...
void PComplex<C,BT>::REMOVE_PIVOT_ROW(const PCell<C,BT>* cell, PCCHAIN& delta, bool trace)
...
template <typename C, typename BT>
void PComplex<C,BT>::COMPUTE_INTERVALS(const Complex<C,BT>& other, bool makegens, bool truncate)
