...
void MComplex<C,BT>::makeCritical_Cored(Cell<C,BT>* tocrit, bool makekgen)
...
template <typename C, typename BT>
void MComplex<C,BT>::makeCritical_Red(Cell<C,BT>* tocrit, bool makekgen)
...
template <typename C, typename BT>
bool MComplex<C,BT>::markPair_Red(Cell<C,BT>* queen, Cell<C,BT>* king, deque<Cell<C,BT>*>& Queue, num rootdim, typename CLIST::iterator& qpos, typename CLIST::iterator& kpos, bool makekgens)
...
// gpaths were manipulated
template <typename C, typename BT>
bool MComplex<C,BT>::markPair_Cored(Cell<C,BT>* king, Cell<C,BT>* queen, deque<Cell<C,BT>*>& Queue, num rootdim, typename CLIST::iterator& kpos, typename CLIST::iterator& qpos, bool makekgens)
...
template <typename C, typename BT>
void MComplex<C,BT>::removeFreeFace(Cell<C,BT>* torem, bool deep)
...
// next cell of lower dimension
template <typename C, typename BT>
void MComplex<C,BT>::removeFreeCoface(Cell<C,BT>* torem, bool deep)
...
template <typename C, typename BT>
num MComplex<C,BT>::getNextCrit_Red (const BT& birth, Cell<C,BT>*& newace, bool deep)
...
template <typename C, typename BT>
num MComplex<C,BT>::getNextCrit_Cored (const BT& birth, Cell<C,BT>*& newace, bool deep)
...
template <typename C, typename BT>
pair<num,int> MComplex<C,BT>::Reduce(const BT& birth, const BT& ignore, bool deep, bool tracer)
...
template <typename C, typename BT>
pair<num,int> MComplex<C,BT>::CoReduce(const BT& birth, const BT& ignore, bool deep, bool tracer)
...
template <typename C, typename BT>
pair<num,bool> MComplex<C,BT>::RedMorsify(const BT& birth, bool deep, BT except, bool tracer)
...
// statuses: (the second integer returned value):
template <typename C, typename BT>
pair<num,bool> MComplex<C,BT>::CoredMorsify(const BT& birth, bool deep, BT except, bool tracer)
...
template <typename C, typename BT>
num MComplex<C,BT>::MorseCoreduce(bool savegens, bool tracer)
...
template <typename C, typename BT>
num MComplex<C,BT>::MorseReduce(bool savegens, bool tracer)
...
template <typename C, typename BT>
num MComplex<C,BT>::TopAlternator(bool redfirst, double thresh, bool savegens, bool tracer)
...
template <typename C, typename BT>
num MComplex<C,BT>::Alternator(const BT& birth, bool savegens)
...
template <typename C, typename BT>
num MComplex<C,BT>::MorseCoreduceExcept(const BT& start, const BT& exception, bool savegens)
...
template <typename C, typename BT>
num MComplex<C,BT>::MorseWrapper_Cored(bool savegens, double thresh)
...
template <typename C, typename BT>
num MComplex<C,BT>::MorseWrapper_Red(bool savegens, double thresh)
...
template <typename C, typename BT>
void MComplex<C,BT>::MorseWrapperExcept_Cored(const BT& start, const BT& except, bool savegens, double thresh)
...
template <typename C, typename BT>
void MComplex<C,BT>::MorseWrapperExcept_Red(const BT& start, const BT& except, bool savegens, double thresh)
