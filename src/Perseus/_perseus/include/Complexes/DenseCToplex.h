...
// functions:
	...
	// makes faces
	bool makeFaces(bool incbirth = false);
	// bool makeFaces(bool);
	...
	void writeComplex(MComplex<C,BT>& mycomp, bool killself = true);
	// void writeComplex(MComplex<C,BT>&, bool);
	bool quickWriteComplex(MComplex<C,BT>& mycomp, bool savemem = true);
	// bool quickWriteComplex(MComplex<C,BT>&, bool);

    void ComputePersistence(string fname = "output");
