...
template <typename C, typename PS, typename BT>
bool RIPS<C,PS,BT>::addEdge(num p1, num p2, const BT& btime)
// bool RIPS<C,PS,BT>::addEdge(num pt1, num pt2, const BT& btime)
{
	// The arguments of addEdge are delcared as const, so need
	// to redefine to be able to change values
	num pt1 = p1; num pt2 = p2;
...
// using ptdim.
template <typename C, typename PS, typename BT>
void RIPS<C,PS,BT>::ComputePersistence(num upto, string fname, bool printcomp)
...
// using ptdim.
template <typename C, typename PS, typename BT>
void RIPS<C,PS,BT>::ComputePersistence_GrowBalls(num upto, string fname)
...
// detected!
template <typename C, typename PS, typename BT>
void RIPS<C,PS,BT>::makeRandom_EdgeShuffle(num n, bool makeEdgefile)
...
// of the file
template <typename C, typename PS, typename BT>
pair<num,bool> RIPS<C,PS,BT>::makeFromFile_GrowBalls(ifstream& infile, bool comred, bool capped, bool witness)
...
template <typename C, typename PS, typename BT>
pair<num,bool> RIPS<C,PS,BT>::makeFromDistMatrixFile(ifstream& infile, bool iscormat, bool isuptr)
...
template <typename C, typename PS, typename BT>
void RIPS<C,PS,BT>::showNbrMatrix(ostream& out) const
...
template <typename C, typename PS, typename BT>
void RIPS<C,PS,BT>::incRIPS_GrowBalls(const num topdim, const BT& start)
...
template <typename C, typename PS, typename BT>
void RIPS<C,PS,BT>::getLowerNbrs_GrowBalls(num index, vector<num>& nbinds, vector<BT>& ebirths, bool dobirths) const
