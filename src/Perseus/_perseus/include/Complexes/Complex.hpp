...
template <typename C, typename BT>
num Complex<C,BT>::dsize(const num dim, BT cap) const
...
template <typename C, typename BT>
void Complex<C,BT>::printSizeInfo(bool dimdetail, bool framedetail, ostream& out) const
...
template <typename C, typename BT>
bool Complex<C,BT>::checkComplex(ostream& out) const
...
template <typename C, typename BT>
void Complex<C,BT>::printList(const BT& birth, const num dim, ostream& out) const
...
template <typename C, typename BT>
void Complex<C,BT>::printFrame(const BT& birth, ostream& out) const
...
template <typename C, typename BT>
bool Complex<C,BT>::removeCell(Cell<C,BT>* tokill, typename CLIST::iterator& cpos, bool remc, bool fmbd, bool fmcb)
...
template <typename C, typename BT>
void Complex<C,BT>::Destroy(bool killcells)
...
template <typename C, typename BT>
void Complex<C,BT>::printSizeStruct(ostream& out) const
...
// helper function to output the complex:
template <typename C, typename BT>
void Complex<C,BT>::print (ostream& out) const
