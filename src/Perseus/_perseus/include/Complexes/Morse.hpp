...
template <typename C, typename BT>
double MComplex<C,BT>::boundaryMatrix (const num& updim, vector<vector<C> >& bmat, BT birth) const
...
template <typename C, typename BT>
double MComplex<C,BT>::getBoundaryDensity (const num& updim, BT birth) const
...
template <typename C, typename BT>
double MComplex<C,BT>::getUnitFraction (const num& updim, BT birth) const
...
template <typename C, typename BT>
void MComplex<C,BT>::showGens (const BT& born, const num& dim, bool resbirth, ostream& out) const
...
template <typename C, typename BT>
void MComplex<C,BT>::memorySaver(BT birth)
...
template <typename C, typename BT>
bool MComplex<C,BT>::removeCell(Cell<C,BT>* tokill, typename CLIST::iterator& pos, bool asCrit)
