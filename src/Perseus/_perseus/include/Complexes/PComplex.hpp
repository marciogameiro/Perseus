...
num PComplex<C,BT>::makeFromComplex(const Complex<C,BT>& topers, bool truncate)
...
template <typename C, typename BT>
bool PComplex<C,BT>::makeBDChains(PCMAP& corr, bool makez2)
...
template <typename C, typename BT>
void PComplex<C,BT>::showInts(ostream& out)
...
template <typename C, typename BT>
void PComplex<C,BT>::showBetti(ostream& out)
