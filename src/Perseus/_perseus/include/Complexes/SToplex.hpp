...
template <typename C, typename PS, typename BT>
bool SToplex<C,PS,BT>::makeFacesOf(Simplex<C,PS,BT>* simp, bool inheritBirths)
...
template <typename C, typename PS, typename BT>
bool SToplex<C,PS,BT>::addSimpFaces(bool inheritBirths)
...
template <typename C, typename PS, typename BT>
bool SToplex<C,PS,BT>::buildTopSimpMap (const vector<Simplex<C,PS,BT>*>& topsimps, bool makeverlist)
...
template <typename C, typename PS,typename BT>
bool SToplex<C,PS,BT>::makeCellComplex(const vector<Simplex<C,PS,BT>*>& topsimps, MComplex<C,BT>& simpcomp, bool inheritBirths)
...
template <typename C, typename PS,typename BT>
num SToplex<C,PS,BT>::populateMap(const vector<Simplex<C,PS,BT>*>& topsimps, bool inheritBirths)
...
template <typename C, typename PS,typename BT>
void SToplex<C,PS,BT>::Destroy(bool deep)
...
template <typename C, typename PS, typename BT>
pair<num,bool> SToplex<C,PS,BT>::makeFromFile(ifstream& infile, bool hasbirths, bool mfd, bool hasdimcap)
...
template <typename C, typename PS, typename BT>
bool SToplex<C,PS,BT>::topWrapper(const vector<Simplex<C,PS,BT>*>& topsimps, string fname)
