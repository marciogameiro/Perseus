...
template <typename C, typename PS, typename BT>
bool CToplex<C,PS,BT>::buildTopCubeMap(const num topdim, const vector<Point<PS>*>& anchs, const vector<BT>* births)
...
template <typename C, typename PS, typename BT>
void CToplex<C,PS,BT>::writeComplex(MComplex<C,BT>& mycomp, bool clearself)
...
template <typename C, typename PS, typename BT>
void CToplex<C,PS,BT>::writeComplexExcept(MComplex<C,BT>& mycomp, const BT& except, bool clearself)
