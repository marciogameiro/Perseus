...
bool DenseCToplex<C,BT>::makeFaces(bool incbirth)
...
template <typename C, typename BT>
void DenseCToplex<C,BT>::writeComplex(MComplex<C,BT>& mycomp, bool killself)
...
template <typename C, typename BT>
bool DenseCToplex<C,BT>::quickWriteComplex(MComplex<C,BT>& mycomp, bool savemem)
...
template<typename C, typename BT>
void DenseCToplex<C,BT>::ComputePersistence(string fname)
