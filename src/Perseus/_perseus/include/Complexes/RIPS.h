...
public:
	...
	pair<num,bool> makeFromFile_GrowBalls(ifstream& infile, bool comred = false, bool capped = false, bool witness = false); // make rips complex by growing epsilon balls around points
	// pair<num,bool> makeFromFile_GrowBalls(ifstream&,bool,bool,bool); // make rips complex by growing epsilon balls around points
	pair<num,bool> makeFromDistMatrixFile(ifstream& infile, bool iscormat = true, bool isuptr = false); // make rips complex from matrix of pairwise distances
