...
// of toadd
template <typename C, typename BT>
void Cell<C,BT>::addBDLink(Cell<C,BT>* toadd, const C& coeff, bool mkcb, bool propdownbt)
...
// of toadd
template <typename C, typename BT>
void Cell<C,BT>::addCBLink(Cell<C,BT>* toadd, const C& coeff, bool mkbd, bool propupbt)
...
template <typename C, typename BT>
void Cell<C,BT>::showGens(ostream& out, bool samebirth, const string buf) const
...
// cell
template <typename C, typename BT>
void Cell<C,BT>::setBD(const CCHAIN& toset, bool mkcb)
...
template <typename C, typename BT>
void Cell<C,BT>::setCB(const CCHAIN& toset, bool mkbd)
...
template <typename C, typename D>
void Chain<C,D>::makeZp(num p) // make Z_p version: kills even coeff cells and makes odd coeff = 1
...
template <typename C, typename D>
num Chain<C,D>::removeUnmarked(bool trace)
...
template <typename C, typename D>
void Chain<C,D>::Destroy(bool killcell)
