...
public:
	...
	virtual void showGens(ostream& out = cout, bool samebirth = false, const string buf = "------ ") const;
	...
	virtual void setBD(const CCHAIN& toset, bool mkcb = true);
	virtual void setCB(const CCHAIN& toset, bool mkbd = true);
	...
	virtual void addBDLink(Cell<C,BT>* toadd, const C& coeff, bool mkcb = true, bool propdownbt = true);
	virtual void addCBLink(Cell<C,BT>* toadd, const C& coeff, bool mkbd = true, bool propupbt = true);
